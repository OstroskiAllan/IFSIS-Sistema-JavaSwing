...
public class CategoriaGerenciar extends javax.swing.JFrame {
    ...
    private void preencherTabela(String campoPesquisa) {
        ...
        try{
            CategoriaDao dao = new CategoriaDao();
            List<Categoria> lista = dao.buscar(campoPesquisa);
     ...
     private void alterar(){
        ...
        if(linhaSelecionada != -1){
            ...
            CategoriaAlterar objeto = new CategoriaAlterar();
            objeto.mostrarCategoria(id.toString());
            
            CategoriaAlterar form = new CategoriaAlterar();
            form.setVisible(true);
            form.mostrarCategoria(id.toString());
        }else {
