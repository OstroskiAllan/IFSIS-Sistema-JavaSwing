 ...
 */
public class CategoriaCadastrar extends javax.swing.JFrame {

    public CategoriaCadastrar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Categoria de produtos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriaCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
