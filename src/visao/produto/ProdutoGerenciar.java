...
public class ProdutoGerenciar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Un. de Medida", "Data de criação"
            }
        ) {
    ...
    private void alterar(){
        ...
        if(linhaSelecionada != -1){
            ...
            ProdutoAlterar objeto = new ProdutoAlterar();
            objeto.mostrarProduto(id.toString());
            
            ProdutoAlterar form = new ProdutoAlterar();
            form.setVisible(true);
            form.mostrarProduto(id.toString());
        }else {
